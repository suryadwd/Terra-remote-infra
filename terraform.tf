...
# for this scenario we will under teh terraform.tf we will add the backend 
# the backend will connect to backend server then needed the bucket name thern the key (terraform.tfstate)  with region and dynamodb name